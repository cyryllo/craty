...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                /*
                 * Celowo NIE base_path() — kod appki jest w git/paczkach aktualizacji,
                 * nie trzeba go duplikować w backupie. Tu ląduje tylko to, czego nie da
                 * się odtworzyć z kodu: zdjęcia przedmiotów, załączniki, logo.
                 * App\Services\BackupService dokłada tu .env w locie, jeśli admin
                 * włączył tę opcję w Ustawienia → Kopie zapasowe.
                 */
                'include' => [
        ...
        'destination' => [
            ...
            /*
             * The disk names on which the backups will be stored. Osobny dysk
             * "backups" (config/filesystems.php) zamiast wbudowanego "local" —
             * żeby kopie (z pełnym dumpem bazy!) leżały poza publicznie
             * dostępnym katalogiem i nie mieszały się z niczym innym.
             */
            'disks' => [
                'backups',
            ],
    ...
    'cleanup' => [
        ...
        'default_strategy' => [
            /*
             * Domyślne — nadpisywane w locie przez App\Services\BackupService
             * wartością z Ustawienia → Kopie zapasowe (retencja w dniach)
             * przed każdym uruchomieniem sprzątania.
             */
