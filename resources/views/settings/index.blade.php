<x-app-layout>
    ...
    <div class="max-w-4xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div>
            <h3 class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">{{ __('Basic settings') }}</h3>
        ...
        @if (auth()->user()->isAdmin())
            <div>
                <h3 class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">{{ __('Advanced settings') }}</h3>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <p class="text-center text-xs text-gray-400">Craty v{{ $appVersion }}</p>
    </div>
</x-app-layout>
